...
$metaboxes = array(
	...
	'fields' => array(
		array(
			...
			'disc' => 'الافتراضي: مخفي. يُظهر أزرار الاتصال في بطاقة المقال، ودجت طلب الخدمة، ودجت الاتصال، الهيدر، والبوب أب. لا يؤثر على الزر العائم (يُدار من إعدادات الفوتر → الأزرار العائمة). واتساب يبقى ظاهراً.',
		),
		array(
