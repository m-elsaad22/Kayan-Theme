...
$metaboxes = array(
	...
	'fields'  => array(
		...
		array(
			...
			'disc'   => 'اختر تصنيفاً أو أكثر — ستظهر نافذة واتساب مفتوحة تلقائياً بدلاً من زري الاتصال والواتساب في مقالات هذه التصنيفات — الرقم: +971586634710',
			'type'   => 'CheckBox',
		...
		array(
			...
			'disc'   => 'يُستخدم عند تفعيل وضع المحادثة من التصنيفات — اتركه فارغاً لاستخدام النص الافتراضي',
			'type'   => 'Text',
			'id'     => 'whatsapp_chat_title',
		),
		array(
			'title'  => 'رسالة الترحيب (إعداد عام)',
			'disc'   => 'تظهر في فقاعة المحادثة عند تفعيل وضع المحادثة من التصنيفات — اتركه فارغاً لاستخدام النص الافتراضي',
			'type'   => 'TextArea',
