...
class kayan_home_compare extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'جدول المقارنة';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'compare', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
