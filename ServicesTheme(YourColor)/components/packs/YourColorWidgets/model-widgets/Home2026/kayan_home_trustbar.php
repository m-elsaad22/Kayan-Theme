...
class kayan_home_trustbar extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'عناصر شريط الثقة العلوي';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'trustbar', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
