...
class kayan_home_services extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'بطاقات الخدمات';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'services', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
