<?/**
 * Homepage 2026 — دعوة للإجراء النهائية
 */
class kayan_home_cta extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'CTA قبل الفوتر';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'cta', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
