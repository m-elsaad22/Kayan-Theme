...
class kayan_home_stats extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'إحصائيات على خلفية داكنة';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'stats', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
