...
class kayan_home_atb extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'العدادات المتحركة';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'atb', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
