...
class kayan_home_cases extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'دراسات الحالة';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'cases', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
