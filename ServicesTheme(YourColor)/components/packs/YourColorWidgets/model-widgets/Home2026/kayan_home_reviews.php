...
class kayan_home_reviews extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'سلايدر آراء العملاء';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'reviews', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
