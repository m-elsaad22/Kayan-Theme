...
class kayan_home_projects extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'شبكة المشاريع مع فلتر';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'projects', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
