<?/**
 * Homepage 2026 — محدد الخدمة الذكي
 */
class kayan_home_finder extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'اختيار الخدمة والإمارة';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'finder', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
