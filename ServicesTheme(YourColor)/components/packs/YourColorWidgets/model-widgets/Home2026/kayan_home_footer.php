<?/**
 * Homepage 2026 — الفوتر
 */
class kayan_home_footer extends Kayan_Home_Section_Widget {

	protected $section_slug = 'footer';
	protected $widget_title = 'الفوتر';
	protected $widget_description = 'أعمدة الفوتر والروابط';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'footer', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
