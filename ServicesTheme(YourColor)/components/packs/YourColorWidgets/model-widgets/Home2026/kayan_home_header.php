<?/**
 * Homepage 2026 — الهيدر والقائمة
 */
class kayan_home_header extends Kayan_Home_Section_Widget {

	protected $section_slug = 'header';
	protected $widget_title = 'الهيدر والقائمة';
	protected $widget_description = 'الشعار، روابط القائمة، واتساب، قائمة الجوال';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'header', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
