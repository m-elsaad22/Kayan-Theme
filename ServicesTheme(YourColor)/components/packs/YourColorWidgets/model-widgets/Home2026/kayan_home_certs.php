<?/**
 * Homepage 2026 — الشهادات والتراخيص
 */
class kayan_home_certs extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'شعارات الاعتماد';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'certs', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
