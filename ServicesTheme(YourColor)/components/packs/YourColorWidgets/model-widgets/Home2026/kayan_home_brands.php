...
class kayan_home_brands extends Kayan_Home_Section_Widget {
	...
	protected $widget_description = 'شريط الشعارات';
	...
	protected function section_fields() {
		...
		if ( function_exists( 'kayan_home_section_header_fields' ) && ! in_array( 'brands', array( 'loader', 'header', 'footer', 'mobile-bar', 'trustbar', 'atb' ), true ) ) {
